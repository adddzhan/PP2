...
if __name__ == '__main__':
    ...
    print("Searching for 'Adilzhan':")
    query_contacts(filter_by="first_name", filter_value="Adilzhan")

    print("Updating Adik's data...")
    update_contact(target_phone="87772048274", new_first_name="AdikUpdated", new_phone="87777777777")

    query_contacts(filter_by="first_name", filter_value="AdikUpdated")

    print("Deleting Akezhan by phone...")
    delete_contact(delete_by="phone", filter_value="87000000000")

    print("Deleting Adilzhan by first_name...")
    delete_contact(delete_by="first_name", filter_value="Adilzhan")
